...
class DatabaseController {
  ...
  performInitialization() {
    ...
    const publicuser = { fields: { ...SchemaController.defaultColumns._Default, ...SchemaController.defaultColumns._PublicUser } };
    const privaterecord = { fields: { ...SchemaController.defaultColumns._Default, ...SchemaController.defaultColumns._PrivateRecord } };
    const records = { fields: { ...SchemaController.defaultColumns._Default, ...SchemaController.defaultColumns._Records } };
